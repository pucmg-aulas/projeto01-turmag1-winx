 ...
 * @author leand
 */
public class CadastrarMesaView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Tamanho da Mesa  :");

        jTextField1.setText("somente números");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastrarMesaView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastrarMesaView().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JButton getConfirmaBtn() {
    return confirmaBtn;
}

public javax.swing.JButton getCancelaBtn() {
    return cancelaBtn;
}

public javax.swing.JTextField getTamanhoMesaField() {
    return jTextField1;
}
}
